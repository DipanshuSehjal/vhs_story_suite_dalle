...
from app.stability_ai import API_KEY, IMAGE_TO_IMAGE_API_URL


class ImageToImageGenerator:
    """
    A class to generate images from text prompts plus image using the Stability AI API.
    ...
    def generate_images_with_stability_ai(self, image_binary_data):
        response = requests.post(
            ...
            files={
                # Adjust filename and MIME type as needed
                'init_image': ('filename.png', image_binary_data, 'image/png')
            },
            data={
    ...
    def save_image_to_print(self, image_data, filename):
